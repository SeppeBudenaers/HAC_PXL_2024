...
entity applyConvolution_applyConvolution_Pipeline_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of applyConvolution_applyConvolution_Pipeline_1 is 
...
attribute shreg_extract : string;
    ...
    signal p_t_fu_38 : STD_LOGIC_VECTOR (1 downto 0) := "00";
    signal empty_fu_122_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_p_t_load : STD_LOGIC_VECTOR (1 downto 0);
    signal p_t_load_load_fu_113_p1 : STD_LOGIC_VECTOR (1 downto 0);
    signal sum_0_21_fu_42 : STD_LOGIC_VECTOR (31 downto 0) := "00000000000000000000000000000000";
    signal sum_1_2_fu_46 : STD_LOGIC_VECTOR (31 downto 0) := "00000000000000000000000000000000";
    signal sum_2_2_fu_50 : STD_LOGIC_VECTOR (31 downto 0) := "00000000000000000000000000000000";
...
begin
    ...
    p_t_fu_38_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
    ...
    sum_0_21_fu_42_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_state1_pp0_stage0_iter0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
    ...
    sum_1_2_fu_46_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_state1_pp0_stage0_iter0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
    ...
    sum_2_2_fu_50_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_state1_pp0_stage0_iter0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                if ((ap_const_boolean_1 = ap_condition_76)) then 
                    sum_2_2_fu_50 <= ap_const_lv32_0;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
    ...
    ap_sig_allocacmp_p_t_load_assign_proc : process(ap_CS_fsm_state1, p_t_fu_38, ap_loop_init)
    begin
