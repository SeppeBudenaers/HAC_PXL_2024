...
convolution_ip.write(addresses.input_buffer, input_buffer.device_address)
convolution_ip.write(addresses.output_buffer, output_buffer.device_address)
convolution_ip.write(addresses.image_width, image_width)
convolution_ip.write(addresses.image_height, image_height)
convolution_ip.write(addresses.num_channels, num_channels)
convolution_ip.write(addresses.start, 0x01)
print("convolution started")
print("waiting for completion")
while convolution_ip.read(addresses.start) & addresses.status == 0:
    pass
