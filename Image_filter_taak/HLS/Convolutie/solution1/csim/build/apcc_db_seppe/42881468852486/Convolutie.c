...
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge25 = phi i32 [ 1, %%.preheader21.lr.ph ], [ %%75, %%._crit_edge24  for 0x%I64xth hint within @applyConvolution  --> \n", ++aesl_llvm_cbe_storemerge25_count);
...
llvm_cbe_tmp__85:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge122 = phi i32 [ 1, %%.lr.ph23 ], [ %%74, %%._crit_edge  for 0x%I64xth hint within @applyConvolution  --> \n", ++aesl_llvm_cbe_storemerge122_count);
...
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__10&4294967295ull)));
  llvm_cbe_storemerge122__PHI_TEMPORARY = (unsigned int )1u;   /* for PHI node */
  goto llvm_cbe_tmp__85;
