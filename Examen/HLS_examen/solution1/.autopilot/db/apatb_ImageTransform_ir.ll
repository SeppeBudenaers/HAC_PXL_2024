; ModuleID = 'C:/02_PXL/HAC_PXL_2024/Examen/HLS_examen/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define void @apatb_ImageTransform_ir(i8* noalias nocapture nonnull readonly "maxi" %imageRGBA, i8* noalias nocapture nonnull "maxi" %output, i32 %centerX, i32 %centerY) local_unnamed_addr #0 {
entry:
  %malloccall = tail call i8* @malloc(i64 65536)
  %imageRGBA_copy = bitcast i8* %malloccall to [65536 x i8]*
  %malloccall1 = tail call i8* @malloc(i64 65536)
  %output_copy = bitcast i8* %malloccall1 to [65536 x i8]*
  %0 = bitcast i8* %imageRGBA to [65536 x i8]*
  %1 = bitcast i8* %output to [65536 x i8]*
  call fastcc void @copy_in([65536 x i8]* nonnull %0, [65536 x i8]* %imageRGBA_copy, [65536 x i8]* nonnull %1, [65536 x i8]* %output_copy)
  call void @apatb_ImageTransform_hw([65536 x i8]* %imageRGBA_copy, [65536 x i8]* %output_copy, i32 %centerX, i32 %centerY)
  call void @copy_back([65536 x i8]* %0, [65536 x i8]* %imageRGBA_copy, [65536 x i8]* %1, [65536 x i8]* %output_copy)
...
declare void @apatb_ImageTransform_hw([65536 x i8]*, [65536 x i8]*, i32, i32)
...
define void @ImageTransform_hw_stub_wrapper([65536 x i8]*, [65536 x i8]*, i32, i32) #5 {
entry:
  ...
  call void @ImageTransform_hw_stub(i8* %4, i8* %5, i32 %2, i32 %3)
  call void @copy_in([65536 x i8]* null, [65536 x i8]* %0, [65536 x i8]* null, [65536 x i8]* %1)
  ret void
}

declare void @ImageTransform_hw_stub(i8*, i8*, i32, i32)
