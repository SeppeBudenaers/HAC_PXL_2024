...
HD_PWD='C:/XilinxDev/HACPXL2024/Image_filter_taak/Vivado/project_1/project_1.runs/design_1_applyConvolution_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_applyConvolution_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_applyConvolution_0_1.tcl
