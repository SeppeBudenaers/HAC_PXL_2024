...
if (AESL_DEBUG_TRACE)
printf("\n  call void @CombLogic_Custom(i1 zeroext false, i1 zeroext false, i1 zeroext true, i1* %%2, i1* %%3) nounwind, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_49_count);
  CombLogic_Custom(0, 0, 1, (bool *)llvm_cbe_tmp__3, (bool *)llvm_cbe_tmp__4);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",0);
printf("\nArgument  = 0x%X",0);
printf("\nArgument  = 0x%X",1);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @CombLogic_Custom(i1 zeroext false, i1 zeroext true, i1 zeroext true, i1* %%6, i1* %%7) nounwind, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_91_count);
  CombLogic_Custom(0, 1, 1, (bool *)llvm_cbe_tmp__7, (bool *)llvm_cbe_tmp__8);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",0);
printf("\nArgument  = 0x%X",1);
printf("\nArgument  = 0x%X",1);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @CombLogic_Custom(i1 zeroext true, i1 zeroext false, i1 zeroext false, i1* %%8, i1* %%9) nounwind, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_124_count);
  CombLogic_Custom(1, 0, 0, (bool *)llvm_cbe_tmp__9, (bool *)llvm_cbe_tmp__10);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",1);
printf("\nArgument  = 0x%X",0);
printf("\nArgument  = 0x%X",0);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @CombLogic_Custom(i1 zeroext true, i1 zeroext true, i1 zeroext false, i1* %%12, i1* %%13) nounwind, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_166_count);
  CombLogic_Custom(1, 1, 0, (bool *)llvm_cbe_tmp__13, (bool *)llvm_cbe_tmp__14);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",1);
printf("\nArgument  = 0x%X",1);
printf("\nArgument  = 0x%X",0);
