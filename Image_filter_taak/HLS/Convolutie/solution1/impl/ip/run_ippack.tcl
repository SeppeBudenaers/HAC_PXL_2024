...
set Library     "hls"
set IPName      "applyConvolution"
set Version     "1.0"
set DisplayName "Applyconvolution"
set Revision    "2113571659"
...
set xo_kernel_name "applyConvolution"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/02_PXL/HAC_PXL_2024/Image_filter_taak/HLS/Convolutie/solution1"
set solution_json_file [file join $solution_dir [file tail $solution_dir]_data.json]
set debug_dir "C:/02_PXL/HAC_PXL_2024/Image_filter_taak/HLS/Convolutie/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {applyConvolution_flow_control_loop_pipe_sequential_init
...
set kernel_xo ""
set detect_deadlock_json "applyConvolution_message_dict.json"

## Variables
set Top "applyConvolution"
set TopNoPrefix "applyConvolution"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x10 image_r_1 W 0x0 "Data signal of image_r" {{0 32 image_r W 0 "Bit 31 to 0 of image_r"}}} {0x14 image_r_2 W 0x0 "Data signal of image_r" {{0 32 image_r W 0 "Bit 63 to 32 of image_r"}}} {0x1c output_r_offset_1 W 0x0 "Data signal of output_r_offset" {{0 32 output_r_offset W 0 "Bit 31 to 0 of output_r_offset"}}} {0x20 output_r_offset_2 W 0x0 "Data signal of output_r_offset" {{0 32 output_r_offset W 0 "Bit 63 to 32 of output_r_offset"}}} {0x28 width W 0x0 "Data signal of width" {{0 32 width W 0 "Bit 31 to 0 of width"}}} {0x30 height W 0x0 "Data signal of height" {{0 32 height W 0 "Bit 31 to 0 of height"}}} {0x38 channels W 0x0 "Data signal of channels" {{0 32 channels W 0 "Bit 31 to 0 of channels"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control s_axi_control_r m_axi_input_r m_axi_output_r"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
