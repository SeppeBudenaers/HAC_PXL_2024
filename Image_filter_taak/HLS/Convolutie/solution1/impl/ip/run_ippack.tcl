...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x10 height W 0x0 "Data signal of height" {{0 32 height W 0 "Bit 31 to 0 of height"}}} {0x18 width W 0x0 "Data signal of width" {{0 32 width W 0 "Bit 31 to 0 of width"}}} {0x20 channels W 0x0 "Data signal of channels" {{0 32 channels W 0 "Bit 31 to 0 of channels"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control s_axi_control_r image_r output_r"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
