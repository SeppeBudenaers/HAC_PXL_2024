...
set Interfaces {
    ...
    s_axi_conv {
        ...
        addr_bits "6"
        port_width "AWADDR 6 WDATA 32 WSTRB 4 ARADDR 6 RDATA 32"
        registers {{0x10 width W 0x0 "Data signal of width" {{0 32 width W 0 "Bit 31 to 0 of width"}}} {0x18 height W 0x0 "Data signal of height" {{0 32 height W 0 "Bit 31 to 0 of height"}}} {0x20 channels W 0x0 "Data signal of channels" {{0 32 channels W 0 "Bit 31 to 0 of channels"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control s_axi_conv m_axi_input_r m_axi_output_r"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
